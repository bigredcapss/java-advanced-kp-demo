...
/**
 * Java High Level REST Client Es高级客户端查询使用使用教程 (Search查询使用教程)
 * 官方文档地址:
 * https://www.elastic.co/guide/en/elasticsearch/client/java-rest/current/java-rest-high.html
 * @author we
 * @date 2021-09-15 20:50
 **/
public class EsHighLevelRestSearchTest {
    ...
    /**
     * 组合查询
     * ----SearchRequest,SearchResponse,QueryBuilders.termQuery()
     * @throws IOException
     */
    ...
    /**
     * 正则查询
     * ----SearchRequest，SearchResponse，QueryBuilders.regexpQuery()
     * @throws IOException
     */
    ...
    /**
     * 范围查询
     * ----SearchRequest,SearchResponse,QueryBuilders.rangeQuery()
     * @throws IOException
     */
    ...
    /**
     * exist查询
     * ----SearchRequest，SearchResponse，QueryBuilders.existsQuery()
     * @throws IOException
     */
    ...
    /**
     * 模糊查询
     * ----SearchRequest，SearchResponse，QueryBuilders.wildcardQuery()
     * @throws IOException
     */
     ...
     * @throws IOException
     */
    private static void generalSearch() throws IOException {
        String type = "_doc";
        String index = "test1";
        // 查询指定的索引库
        SearchRequest searchRequest = new SearchRequest(index);
...
//                .maxExpansions(10);
        ...
        for (Aggregation agg : aggregations) {
            ...
            if (type.equals(TermsAggregationBuilder.NAME)) {
                Terms.Bucket elasticBucket = ((Terms) agg).getBucketByKey("average_age");
